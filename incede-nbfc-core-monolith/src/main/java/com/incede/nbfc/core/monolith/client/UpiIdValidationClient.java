...
@FeignClient(name = "Kyc-service", url = "${decentro.api.url}", configuration = DecentroClientInterceptorConfig.class, fallbackFactory = UpiIdValidationFallbackFactory.class)
public interface UpiIdValidationClient
{
     ...
     * @return
     */
    default UpiAccountDetailsResponseDto getValidatedUpiIdDetailsFallBack(BankValidationRequestDto bankvalidationrequestdto, Throwable throwable){
