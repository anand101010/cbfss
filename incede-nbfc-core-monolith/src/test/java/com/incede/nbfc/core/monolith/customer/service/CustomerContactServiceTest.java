...
class CustomerContactServiceTest {
    ...
    void saveContact_success() {
        ...
        when(contactMapper.toResponseDto(contact))
                .thenReturn(new CustomerContactResponseDto.Contact());

        CustomerContactResponseDto result = service.saveContact(customerId, requestDto);
    ...
    void updateContact_success() {
        ...
        CustomerContactResponseDto result = service.updateContact(customerId, contactId, requestDto);
    ...
    void getContacts_success() {
        ...
        CustomerContactResponseDto result = service.getContacts(customerId);
